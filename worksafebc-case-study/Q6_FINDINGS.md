...
| 3 | Mean of numpy array [2, 4, 6] | 4 | (2 + 4 + 6) / 3 = 12 / 3 = 4. |
...
6: Recall up, precision down | 7: Number of clients served | 8: Employer C (23.1%) | 9: Estimate performance on unseen data | 10: Wide range of distinct values
